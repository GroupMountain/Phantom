...
constexpr char kEnUs[] = R"json({
  ...
  "phantom.form.lines.content": "Line count: {count}",
  "phantom.form.lines.add": "+ Add line",
  "phantom.form.lines.add_title": "Add line",
  "phantom.form.lines.item": "{line}. [{state}] {text}",
  "phantom.form.line.title": "Line {line}",
  "phantom.form.line.content": "State: {state}\\nText: {text}\\nVariants: {variants}\\nInterval: {interval} ms",
  "phantom.form.line.edit_text": "Edit text",
  "phantom.form.line.dynamic_settings": "Dynamic settings",
  "phantom.form.line.delete": "Delete line",
  "phantom.form.line.edit_text_title": "Edit line {line}",
  "phantom.form.line.delete_title": "Delete line {line}",
  "phantom.form.line.delete_content": "This removes the selected line. If it is the last line, Phantom will keep one empty line.",
  "phantom.form.field.line_text": "Line text",

  "phantom.form.dynamic.title": "Dynamic lines {name}",
  "phantom.form.dynamic.content": "Select a line to configure its dynamic content.",
  "phantom.form.dynamic.item": "{line}. [{state}] {text} / {interval} ms",
  "phantom.form.dynamic.line_title": "Dynamic line {line}",
  "phantom.form.dynamic.summary": "State: {state}\\nVariants: {variants}\\nInterval: {interval} ms",
  "phantom.form.dynamic.enable": "Enable animation",
  "phantom.form.dynamic.disable": "Disable animation",
  "phantom.form.dynamic.frames": "Animation frames",
  "phantom.form.dynamic.playback": "Playback settings",
  "phantom.form.dynamic.frames_title": "Animation frames for line {line}",
  "phantom.form.dynamic.frames_content": "Frame count: {count}",
  "phantom.form.dynamic.frame_add": "+ Add frame",
  "phantom.form.dynamic.frame_item": "Frame {frame}: {text}",
  "phantom.form.dynamic.frame_title": "Frame {frame}",
  "phantom.form.dynamic.frame_edit": "Edit frame text",
  "phantom.form.dynamic.frame_delete": "Delete frame",
  "phantom.form.dynamic.frame_edit_title": "Edit frame {frame}",
  "phantom.form.dynamic.frame_add_title": "Add animation frame",
  "phantom.form.dynamic.frame_delete_title": "Delete frame {frame}",
  "phantom.form.dynamic.frame_delete_content": "This removes the selected animation frame. At least one frame will be kept.",
  "phantom.form.dynamic.frame_text": "Frame text",
  "phantom.form.dynamic.playback_title": "Playback settings",
  "phantom.form.dynamic.variables": "Variables: {player}, {online}, {dimension}, {hologram}, {line}, {contentIndex}, {x}, {y}, {z}",
  "phantom.form.field.dynamic_enabled": "Enable dynamic content",
  "phantom.form.field.static_text": "Static text",
...
constexpr char kZhCn[] = R"json({
  ...
  "phantom.form.lines.content": "\u5f53\u524d\u884c\u6570\uff1a{count}",
  "phantom.form.lines.add": "+ \u6dfb\u52a0\u884c",
  "phantom.form.lines.add_title": "\u6dfb\u52a0\u884c",
  "phantom.form.lines.item": "{line}. [{state}] {text}",
  "phantom.form.line.title": "\u7b2c {line} \u884c",
  "phantom.form.line.content": "\u72b6\u6001\uff1a{state}\\n\u6587\u672c\uff1a{text}\\n\u53d8\u4f53\u6570\uff1a{variants}\\n\u95f4\u9694\uff1a{interval} \u6beb\u79d2",
  "phantom.form.line.edit_text": "\u7f16\u8f91\u6587\u672c",
  "phantom.form.line.dynamic_settings": "\u52a8\u6001\u8bbe\u7f6e",
  "phantom.form.line.delete": "\u5220\u9664\u884c",
  "phantom.form.line.edit_text_title": "\u7f16\u8f91\u7b2c {line} \u884c",
  "phantom.form.line.delete_title": "\u5220\u9664\u7b2c {line} \u884c",
  "phantom.form.line.delete_content": "\u8fd9\u4f1a\u5220\u9664\u9009\u4e2d\u7684\u6587\u672c\u884c\u3002\u5982\u679c\u8fd9\u662f\u6700\u540e\u4e00\u884c\uff0cPhantom \u4f1a\u4fdd\u7559\u4e00\u4e2a\u7a7a\u884c\u3002",
  "phantom.form.field.line_text": "\u884c\u6587\u672c",

  "phantom.form.dynamic.title": "{name} \u7684\u52a8\u6001\u6587\u672c\u884c",
  "phantom.form.dynamic.content": "\u9009\u62e9\u4e00\u884c\u6765\u914d\u7f6e\u5b83\u7684\u52a8\u6001\u5185\u5bb9\u3002",
  "phantom.form.dynamic.item": "{line}. [{state}] {text} / {interval} \u6beb\u79d2",
  "phantom.form.dynamic.line_title": "\u52a8\u6001\u6587\u672c\u884c {line}",
  "phantom.form.dynamic.summary": "\u72b6\u6001\uff1a{state}\\n\u53d8\u4f53\u6570\uff1a{variants}\\n\u95f4\u9694\uff1a{interval} \u6beb\u79d2",
  "phantom.form.dynamic.enable": "\u542f\u7528\u52a8\u753b",
  "phantom.form.dynamic.disable": "\u5173\u95ed\u52a8\u753b",
  "phantom.form.dynamic.frames": "\u52a8\u753b\u5e27",
  "phantom.form.dynamic.playback": "\u64ad\u653e\u8bbe\u7f6e",
  "phantom.form.dynamic.frames_title": "\u7b2c {line} \u884c\u7684\u52a8\u753b\u5e27",
  "phantom.form.dynamic.frames_content": "\u5f53\u524d\u5e27\u6570\uff1a{count}",
  "phantom.form.dynamic.frame_add": "+ \u6dfb\u52a0\u5e27",
  "phantom.form.dynamic.frame_item": "\u7b2c {frame} \u5e27\uff1a{text}",
  "phantom.form.dynamic.frame_title": "\u7b2c {frame} \u5e27",
  "phantom.form.dynamic.frame_edit": "\u7f16\u8f91\u5e27\u6587\u672c",
  "phantom.form.dynamic.frame_delete": "\u5220\u9664\u5e27",
  "phantom.form.dynamic.frame_edit_title": "\u7f16\u8f91\u7b2c {frame} \u5e27",
  "phantom.form.dynamic.frame_add_title": "\u6dfb\u52a0\u52a8\u753b\u5e27",
  "phantom.form.dynamic.frame_delete_title": "\u5220\u9664\u7b2c {frame} \u5e27",
  "phantom.form.dynamic.frame_delete_content": "\u8fd9\u4f1a\u5220\u9664\u9009\u4e2d\u7684\u52a8\u753b\u5e27\u3002\u81f3\u5c11\u4f1a\u4fdd\u7559\u4e00\u5e27\u3002",
  "phantom.form.dynamic.frame_text": "\u5e27\u6587\u672c",
  "phantom.form.dynamic.playback_title": "\u64ad\u653e\u8bbe\u7f6e",
  "phantom.form.dynamic.variables": "\u53d8\u91cf\uff1a{player}\u3001{online}\u3001{dimension}\u3001{hologram}\u3001{line}\u3001{contentIndex}\u3001{x}\u3001{y}\u3001{z}",
  "phantom.form.field.dynamic_enabled": "\u542f\u7528\u52a8\u6001\u5185\u5bb9",
  "phantom.form.field.static_text": "\u9759\u6001\u6587\u672c",
